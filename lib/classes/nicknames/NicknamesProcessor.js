import BaseDiscordModule from "../base/BaseDiscordModule";
import NicknameSanitizer from "./NicknameSanitizer";
import { GuildModel } from "../Database";
import { ChannelType } from "discord-api-types/v10";
import { PermissionsBitField } from "discord.js";
import { createModuleLogger } from "../Utils";

const logger = createModuleLogger("nicknameProcessor");

export default class NicknamesProcessor extends BaseDiscordModule {
	/**
	...
	#attachEventListeners() {
		...
		this.client.logsProcessor.on("rename", this.#onMemberRename.bind(this));
	 ...
	 */
	async #onMemberRename(previousMember, currentMember) {
