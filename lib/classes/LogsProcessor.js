...
class LogsProcessor extends BaseDiscordModule {
	...
	#loadDiscordListeners() {
		...
		this._client.on("guildMemberRemove", this.#onGuildMemberRemove.bind(this));
		this._client.on("guildMemberUpdate", this.#onGuildMemberUpdate.bind(this));
		this._client.on("guildBanAdd", guildBanDetails => this.#onGuildBanUpdate("ban", guildBanDetails));
		this._client.on("guildBanRemove", guildBanDetails => this.#onGuildBanUpdate("unban", guildBanDetails));
		this._client.on("messageCreate", this.#onMessageCreate.bind(this));
		this._client.on("messageUpdate", this.#onMessageUpdate.bind(this));
		this._client.on("messageDelete", this.#onMessageDelete.bind(this));
	}
