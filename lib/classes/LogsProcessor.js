	...
	static #eventMessageRenderer = {
			...
			embed
				...
				.addField(
					...
					embed.lang.get("embed.logs.messageUpdate.info.value", {
						...
						messageUpdatedAt: embed.lang.formatDate(curr.editedAt)
					})
				)
		...
		msgdelete: message => {
			...
			embed
				...
				.addField(
					embed.lang.get("embed.logs.messageDelete.info.name"),
					embed.lang.get("embed.logs.messageDelete.info.value", {
