const { fileExtension, fileName, createModuleLogger, checkObjectKeySafety } = require("../Utils.js");
...
class Lang {
	...
	static async initialize() {
		...
		files.forEach(fileWithExtension => {
			...
			logger.debug(`Language pack loaded: ${pack.languageName} (${pack.version})!`);
		});
