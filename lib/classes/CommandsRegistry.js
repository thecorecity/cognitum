...
class CommandsRegistry {
     ...
     * @type {Object<string, BaseCommand.constructor>}
     */
    static commands = {};
    ...
    /**
     * Map of categories.
     * @type {Object<string, BaseCategory.constructor>}
     */
    static categories = {};
    ...
    static async initialize() {
        ...
        commandsDirectory.forEach(filename => {
            ...
            if (extension !== "js")
                return;
            this.loadCommandFromPath("../commands/" + filename);
        });
    }
    ...
    static loadCommandFromPath(requirePath) {
        ...
        try {
            ...
            log("error", "Command loading failed!");
            process.exit();
        }
     ...
     * @return {BaseCommand.constructor|boolean} Command class if command found. If no commands found, method will
     *     return `false`.
     * @example
     ...
     * @return {boolean|BaseCategory.constructor} Category class if category found. If not categories found, method
     *     will return `false`.
     */
