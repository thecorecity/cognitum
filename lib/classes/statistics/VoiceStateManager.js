...
import {GuildMemberModel, GuildModel, UserModel, VoiceStatisticsModel} from "../Database";
 ...
 */
export default class VoiceStateManager extends BaseDiscordModule {
	/** @type {Object<Date>} */
	#storage = {};
	...
	async #onDisconnected(targetMember) {
		...
		// Clear the date from the storage to free memory
		delete this.#storage[targetMember.id];
	}
	...
	static async #sendVoiceStatistic(targetMember, startDate) {
		...
		// Do not send stats lower than 1 second
