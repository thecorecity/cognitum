const CommandContextValidator = require("../validation/CommandContextValidator");
...
class BaseCommand {
	 ...
	 * @param {ReplacementValuesMap} [options] (Optional) Fields for replacements.
	 * @return {string} Resolved from Lang text or field code itself if nothing found.
	 */
	resolveLang(code, options) {
		return this.context.lang.get(code, options);
	}
