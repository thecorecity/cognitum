...
const { VoiceStatistics, GuildMember } = require("./Database");
...
class VoiceStateManager {
	 ...
	 * @param {VoiceState} before State before event happened.
	 * @param {VoiceState} after State after event happened.
	 */
	...
	/**
	 * Handle voice join.
	 * @param {GuildMember} targetMember Database member instance.
	 * @return {Promise<void>}
	 */
	 ...
	 * @param {GuildMember} targetMember Target member instance.
	 ...
	 * @param {VoiceState} afterState
	 * @return {Promise<GuildMember>} Guild member model instance.
	 */
