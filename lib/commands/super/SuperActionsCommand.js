import BaseSuperUserCommand from "../../classes/base/commands/BaseSuperUserCommand";
import SuperUserError from "../../classes/errors/commands/SuperUserError";
import TrackingSettingsCommand from "../basic/TrackingSettingsCommand";
import { UserModel } from "../../classes/Database";
import HiddenCategory from "../../categories/HiddenCategory";
import { createModuleLogger, formatDataSize, formatTimeString } from "../../classes/Utils";
import DefaultEmbed from "../../classes/embed/DefaultEmbed";
import GuildsCachingTask from "../../classes/statistics/tasks/GuildsCachingTask";

const logger = createModuleLogger("sudo");

export default class SuperActionsCommand extends BaseSuperUserCommand {
	async run() {
