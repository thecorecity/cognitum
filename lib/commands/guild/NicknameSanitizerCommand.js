...
import NicknameSanitizer from "../../classes/nicknames/NicknameSanitizer";
import ArgumentError from "../../classes/errors/ArgumentError";
import { PermissionsBitField } from "discord.js";

export default class NicknameSanitizerCommand extends BaseCommand {
	async run() {
	...
	static validators = {
		...
		botPermission: PermissionsBitField.Flags.ManageNicknames,
